...
namespace FaceTracking3D
{
    ...
    {
        private Viewport3D faceViewport;
        public Viewport3D FaceViewport
        {
            get
            {
                return this.faceViewport;
            }
            set
            {
                this.faceViewport = value;
            }
        }
    }
    ...
    public partial class TexturedFaceMeshViewer : UserControl, IDisposable
    {
        ...
        public FaceMesh FaceMeshData
        {
            get
            {
                return this.faceMeshData;
            }
            set
            {
                this.faceMeshData = value;
                OnPropertyChanged("FaceMeshData");
            }
        }
